...
python3 ../tests/test_judgment_memory_ledger.py   # mock-based, no necesita
                                                    ...
                                                    # igual
bun run ../tests/judgment_qdrant.verify.ts   			# ESTE sí necesita
                                                        # los containers
                                                        # arriba — llamadas
                                                        # embed/upsert/search
                                                        # reales
...
`judgment_qdrant.verify.ts` debería imprimir `ALL CHECKS PASSED`. Si no lo hace:
