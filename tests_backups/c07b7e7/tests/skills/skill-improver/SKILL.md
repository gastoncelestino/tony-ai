...
5. In apply mode, edit only safe issues, preserve content, create supporting files when needed, then rerun or request `/sdd-skill-registry refresh` (OpenCode slash command).
